...
public class RevivalWand extends Item {
    private static final Map<EntityType<? extends MobEntity>, RevivalWand> WAND = Maps.newIdentityHashMap();
    private final EntityType<?> type;

    public RevivalWand(EntityType<? extends MobEntity> type, Settings settings) {
        super(settings);
        this.type = type;
        WAND.put(type, this);
    }
    ...
    @Nullable
    public static RevivalWand forEntity(@Nullable EntityType<?> type) {
        return (RevivalWand) WAND.get(type);
    }

    public static Iterable<RevivalWand> getAll() {
        return Iterables.unmodifiableIterable(WAND.values());
    }
